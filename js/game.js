...
game.hero_moving = function(event) {
  ...
  //here goes the description of what happens if we press the arrows
   ...
   //what happens if we press the left arrow
    ...
    game.updateposition();
	  	  ...
	  	  if(game.walking) {
	timer = setInterval(function () {inputStates.left = true; game.updateposition()}, 60)
	} else {
	clearInterval(timer);
	}
  }
  ...
  //what happens if we press the right arrow
    ...
    game.updateposition();
	  ...
	  if(game.walking) {
	timer = setInterval(function () {inputStates.right = true; game.updateposition()}, 60)
	} else {
	clearInterval(timer);
	}
  ...
  //what happens if we press the up arrow
	...
	if(game.walking) {
	timer = setInterval(function () {inputStates.up = true; game.updateposition()}, 60)
	} else {
	clearInterval(timer);
	}
  ...
  //what happens if we pres the down arrow
    ...
    game.updateposition();
if(game.walking) {
	timer = setInterval(function () {inputStates.down = true; game.updateposition()}, 60)
	} else {
	clearInterval(timer);
	}
  }
...
window.addEventListener('mousedown', game.hero_moving, false);
